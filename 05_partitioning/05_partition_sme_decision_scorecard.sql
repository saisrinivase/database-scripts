/*
Oracle DBA Script: Partition Sme Decision Scorecard
Purpose: Provide Oracle DBA diagnostics for partition sme decision scorecard.
Area: Partitioning
...
PROMPT Partition Sme Decision Scorecard
