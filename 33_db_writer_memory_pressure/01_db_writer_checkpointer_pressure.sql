/*
Oracle DBA Script: Db Writer Checkpointer Pressure
Purpose: Provide Oracle DBA diagnostics for db writer checkpointer pressure.
...
PROMPT Db Writer Checkpointer Pressure
