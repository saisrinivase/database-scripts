/*
Oracle DBA Script: Sql Resource Percent By Service
Purpose: Provide Oracle DBA diagnostics for sql resource percent by service.
...
PROMPT Sql Resource Percent By Service

SELECT service, COUNT(*) AS sql_count,
