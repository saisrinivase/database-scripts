...
Object lifecycle repository, snapshots, advisory views, and capacity reporting.

Scripts in this area: `12`.

## Usage

Run with the mysql client, for example: `mysql -u root -p < 37_object_lifecycle_capacity/<script>.sql`.
