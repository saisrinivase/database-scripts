...
-- ----------------------+-----------------------+--------------+-------------+----------------------------------------------------------------
--  Core Objects         | INDEX                 |           30 | PRESENT     | User schemas only
--  Core Objects         | MVIEW                 |            1 | PRESENT     | User schemas only
--  Core Objects         | SEQUENCE              |           17 | PRESENT     | User schemas only
--  Core Objects         | TABLE                 |           30 | PRESENT     | User schemas only
...
--  Security             | GRANT_TABLE_PRIVILEGE |          242 | PRESENT     | Rows from information_schema.table_privileges
