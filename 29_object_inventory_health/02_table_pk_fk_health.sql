...
--  dba_metrics      | connection_snapshots    |        -1 | 16 kB      | NO              |                 0 |                0 |                 0 | ADD_PRIMARY_KEY
--  dba_metrics      | database_size_snapshots |        -1 | 16 kB      | NO              |                 0 |                0 |                 0 | ADD_PRIMARY_KEY
--  dba_metrics      | index_size_snapshots    |        -1 | 16 kB      | NO              |                 0 |                0 |                 0 | ADD_PRIMARY_KEY
--  dba_metrics      | table_size_snapshots    |        -1 | 16 kB      | NO              |                 0 |                0 |                 0 | ADD_PRIMARY_KEY
--  dba_metrics      | wal_snapshots           |        -1 | 16 kB      | NO              |                 0 |                0 |                 0 | ADD_PRIMARY_KEY
...
--  migration_v2_lab | customer_contact_compat |     90000 | 12 MB      | YES             |                 0 |                0 |                 1 | OK
--  migration_v1_lab | child_transactions      |    120000 | 11 MB      | YES             |                 1 |                0 |                 2 | OK
--  migration_v1_lab | stale_stats_table       |     60000 | 7760 kB    | YES             |                 0 |                0 |                 1 | OK
--  public           | pgbench_branches        |      2000 | 7048 kB    | YES             |                 0 |                0 |                 1 | OK
--  migration_v1_lab | product_catalog         |     50000 | 6024 kB    | YES             |                 0 |                0 |                 2 | OK
--  migration_v2_lab | partitioned_events_2025 |     52194 | 5552 kB    | YES             |                 0 |                0 |                 1 | OK
--  migration_v2_lab | partitioned_events_2026 |     47806 | 5096 kB    | YES             |                 0 |                0 |                 1 | OK
--  migration_v2_lab | customer_staging_no_pk  |     60000 | 5008 kB    | YES             |                 0 |                0 |                 1 | OK
--  migration_v1_lab | dml_bloat_table         |     12000 | 4248 kB    | YES             |                 0 |                0 |                 1 | OK
--  migration_v2_lab | parent_accounts         |     50000 | 4088 kB    | YES             |                 0 |                1 |                 1 | OK
--  public           | pgbench_tellers         |     20000 | 3712 kB    | YES             |                 0 |                0 |                 1 | OK
--  migration_v1_lab | orders_no_pk            |     10000 | 864 kB     | YES             |                 0 |                0 |                 1 | OK
--  migration_v1_lab | parent_accounts         |     10000 | 784 kB     | YES             |                 0 |                1 |                 1 | OK
--  migration_v2_lab | quoted_orders           |      5000 | 488 kB     | YES             |                 0 |                0 |                 1 | OK
--  migration_v1_lab | sales_orders            |      1000 | 128 kB     | YES             |                 0 |                0 |                 1 | OK
