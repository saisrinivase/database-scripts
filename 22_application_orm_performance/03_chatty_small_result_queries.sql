...
--   3689806360888379158 | 1120000 | 1120000 |            1.0000 |   0.001003262473214298 | 1123.6539700004319 | SELECT $2 FROM ONLY "migration_v2_lab"."parent_accounts" x WHERE "account_id" OPERATOR(pg_catalog.=) $1 FOR KEY SHARE OF x
--   3689806360888379158 |  480000 |  480000 |            1.0000 |  0.0007798826791666557 |  374.3436859998984 | SELECT $2 FROM ONLY "migration_v1_lab"."parent_accounts" x WHERE "account_id" OPERATOR(pg_catalog.=) $1 FOR KEY SHARE OF x
