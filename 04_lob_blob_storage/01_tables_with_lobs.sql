/*
Oracle DBA Script: Tables With Lobs
Purpose: Provide Oracle DBA diagnostics for tables with lobs.
...
PROMPT Tables With Lobs

SELECT l.owner, l.table_name, l.column_name, l.segment_name, l.index_name,
       l.tablespace_name, l.securefile, l.compression, l.deduplication, l.in_row,
