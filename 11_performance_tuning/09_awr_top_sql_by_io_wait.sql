/*
Oracle DBA Script: AWR Top SQL By IO Wait
Purpose: Rank SQL by I/O wait time using AWR SQLSTAT deltas.
...
WITH sql_agg AS (
    SELECT st.sql_id,
           ...
           SUM(st.iowait_delta) AS rank_value
