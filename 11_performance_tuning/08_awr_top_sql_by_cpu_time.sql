/*
Oracle DBA Script: AWR Top SQL By CPU Time
Purpose: Rank SQL by CPU time using AWR SQLSTAT deltas.
...
PROMPT AWR Top SQL By CPU Time
...
WITH sql_agg AS (
    SELECT st.sql_id,
           ...
           SUM(st.cpu_time_delta) AS rank_value
